...
=======*/
	...
	static String generateStickers(CalendarDate date) {
		...
		String iurl2 =
				...
				.toExternalForm();
		 String s = "<hr><hr><table border=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td><a href=\"memoranda:importstickers\"><b>"+Local.getString("Import note as .txt")+"</b></a></td><td><a href=\"memoranda:exportstickerst\"><b>"+Local.getString("Export note as .txt")+"</b></a><td><a href=\"memoranda:exportstickersh\"><b>"+Local.getString("Export note as .html")+"</b></a></td></tr></table>"
