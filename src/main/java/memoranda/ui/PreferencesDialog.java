...
public class PreferencesDialog extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7305875875029139360L;
	...
	JRadioButton askConfirmChB = new JRadioButton();
	...
	JRadioButton enSystrayChB = new JRadioButton();

	JRadioButton startMinimizedChB = new JRadioButton();

	JRadioButton enSplashChB = new JRadioButton();

	JRadioButton enL10nChB = new JRadioButton();

	JRadioButton firstdow = new JRadioButton();
	...
	JRadioButton enableSoundCB = new JRadioButton();
	...
	JRadioButton antialiasChB = new JRadioButton();
