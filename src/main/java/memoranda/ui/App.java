...
public class App {
	...
	public static final String VERSION_INFO = "Lebkuchen";
	public static final Date BUILD_INFO = Calendar.getInstance().getTime();
	...
	private void showSplash() {
		splash = new JFrame();
		ImageIcon spl =
			new ImageIcon(App.class.getResource("/ui/taigakinglogo.png"));
		JLabel l = new JLabel();
		l.setSize(400, 300);
		l.setIcon(spl);
		...
		l.setLocation(((screenSize.width - 400) / 2), (screenSize.height - 300) / 2);
