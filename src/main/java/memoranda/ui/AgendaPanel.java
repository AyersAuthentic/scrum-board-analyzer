				...
				if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
					...
					if (d.equalsIgnoreCase("memoranda:events"))
						...
						if (!dlg.CANCELLED) {
						 ...
						 String name = JOptionPane.showInputDialog(parent,Local.getString("Input name of the file to export"),null);
						...
						final JFrame parent = new JFrame();
						String name = JOptionPane.showInputDialog(parent,Local.getString("Input name of the file to import"),null);
