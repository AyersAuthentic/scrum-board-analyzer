...
import main.java.memoranda.ui.taiga.CompareSprintsPanel;
import main.java.memoranda.ui.taiga.ProjectPanel;
import main.java.memoranda.ui.taiga.ProjectPanel;
import main.java.memoranda.ui.taiga.CompareSprintsPanel;
...
public class WorkPanel extends JPanel {
	...
	public TaigaPanel taigaDashboard = new TaigaPanel();
	public CollaboratorPanel collabPanel = new CollaboratorPanel();
	public CompareSprintsPanel compareSprints = new CompareSprintsPanel();
	public ProjectPanel projectPanel = new ProjectPanel();
	public JButton projectB = new JButton();
	public JButton agendaB = new JButton();
	public JButton tasksB = new JButton();
	public JButton eventsB = new JButton();
	public JButton filesB = new JButton();
	public JButton taigaDash = new JButton();
	public JButton compareSprint = new JButton();
	...
	void jbInit() throws Exception {
		...
		filesB.setText(Local.getString("Collaborators"));
		...
		taigaDash.setSelected(true);
		taigaDash.setSelected(true);
		taigaDash.setMargin(new Insets(0, 0, 0, 0));
		taigaDash.setIcon(
		        new ImageIcon(
		                main.java.memoranda.ui.AppFrame.class.getResource(
		                        "/ui/icons/kinglogo.png")));
		taigaDash.setVerticalTextPosition(SwingConstants.BOTTOM);
		taigaDash.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		            taigaDash_actionPerformed(e);
		    }
		});
		taigaDash.setFont(new java.awt.Font("Dialog", 1, 10));
        taigaDash.setVerticalAlignment(SwingConstants.TOP);
        taigaDash.setText(Local.getString("Dashboard"));
        taigaDash.setHorizontalTextPosition(SwingConstants.CENTER);
        taigaDash.setFocusPainted(false);
        taigaDash.setBorderPainted(false);
        taigaDash.setContentAreaFilled(false);
        taigaDash.setPreferredSize(new Dimension(50, 50));
        taigaDash.setMinimumSize(new Dimension(30, 30));
        taigaDash.setOpaque(false);
        taigaDash.setMaximumSize(new Dimension(60, 80));
        taigaDash.setBackground(Color.white);
          
		projectB.setSelected(true);
		projectB.setMargin(new Insets(0, 0, 0, 0));
		projectB.setIcon(
		        new ImageIcon(
		                main.java.memoranda.ui.AppFrame.class.getResource(
		                        "/ui/icons/kinglogo.png")));
		projectB.setVerticalTextPosition(SwingConstants.BOTTOM);
		projectB.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		            projectB_actionPerformed(e);
		    }
		});
		projectB.setFont(new java.awt.Font("Dialog", 1, 10));
		projectB.setVerticalAlignment(SwingConstants.TOP);
		projectB.setText(Local.getString("Projects"));
		projectB.setHorizontalTextPosition(SwingConstants.CENTER);
		projectB.setFocusPainted(false);
		projectB.setBorderPainted(false);
		projectB.setContentAreaFilled(false);
		projectB.setPreferredSize(new Dimension(50, 50));
		projectB.setMinimumSize(new Dimension(30, 30));
		projectB.setOpaque(false);
		projectB.setMaximumSize(new Dimension(60, 80));
		projectB.setBackground(Color.white);


        compareSprint.setSelected(true);
        compareSprint.setSelected(true);
        compareSprint.setMargin(new Insets(0, 0, 0, 0));
        compareSprint.setIcon(
                new ImageIcon(
                        main.java.memoranda.ui.AppFrame.class.getResource(
                                "/ui/icons/kinglogo.png")));
        compareSprint.setVerticalTextPosition(SwingConstants.BOTTOM);
        compareSprint.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e) {
                    compareSprints_actionPerformed(e);
            }
        });
        compareSprint.setFont(new java.awt.Font("Dialog", 1, 10));
        compareSprint.setVerticalAlignment(SwingConstants.TOP);
        compareSprint.setText(Local.getString("Compare"));
        compareSprint.setHorizontalTextPosition(SwingConstants.CENTER);
        compareSprint.setFocusPainted(false);
        compareSprint.setBorderPainted(false);
        compareSprint.setContentAreaFilled(false);
        compareSprint.setPreferredSize(new Dimension(50, 50));
        compareSprint.setMinimumSize(new Dimension(30, 30));
        compareSprint.setOpaque(false);
        compareSprint.setMaximumSize(new Dimension(60, 80));
        compareSprint.setBackground(Color.white);
        
		this.add(toolBar, BorderLayout.WEST);
		this.add(panel, BorderLayout.CENTER);
		panel.add(dailyItemsPanel, "DAILYITEMS");
		panel.add(taigaDashboard, "TAIGADASHBOARD");
		panel.add(collabPanel, "COLLABORATORS");
		panel.add(compareSprints, "COMPARESPRINTS");
		panel.add(projectPanel, "PROJECTPANEL");
		toolBar.add(agendaB, null);
		toolBar.add(eventsB, null);
		toolBar.add(tasksB, null);
		toolBar.add(notesB, null);
		toolBar.add(taigaDash, null);
		toolBar.add(filesB, null);
		toolBar.add(compareSprint, null);
		toolBar.add(projectB, null);
		currentB = agendaB;
		// Default blue color
	...
	public void selectPanel(String pan) {
		if (pan != null) {
			...
			else if (pan.equals("COLLABORATORS"))
				filesB_actionPerformed(null);
			else if (pan.equals("TAIGADASHBOARD"))
			    taigaDash_actionPerformed(null);
			else if (pan.contentEquals("COMPARESPRINTS"))
			    compareSprints_actionPerformed(null);
			else if (pan.equals("PROJECTPANEL"))
				projectB_actionPerformed(null);
		}
	}
	...
	public void filesB_actionPerformed(ActionEvent e) {
		cardLayout1.show(panel, "COLLABORATORS");
		setCurrentButton(filesB);
		Context.put("CURRENT_PANEL", "COLLABORATORS");
	}
	
	public void taigaDash_actionPerformed(ActionEvent e) {
	    cardLayout1.show(panel, "TAIGADASHBOARD");
        setCurrentButton(taigaDash);
        Context.put("CURRENT_PANEL", "TAIGADASHBOARD");
	}
	

	public void compareSprints_actionPerformed(ActionEvent e) {
        cardLayout1.show(panel, "COMPARESPRINTS");
        setCurrentButton(compareSprint);
        Context.put("CURRENT_PANEL", "COMPARESPRINTS");
    }

   	public void projectB_actionPerformed(ActionEvent e) {
	    cardLayout1.show(panel, "PROJECTPANEL");
        setCurrentButton(projectB);
        Context.put("CURRENT_PANEL", "PROJECTPANEL");
	}
