...
public class SprintTable extends Table {
  Project project;
  
  public SprintTable(Project project){
    super(new LinkedList<String>(project.getArbitrarySprint().toSimpleMap().keySet())); // get keyset of arbitrary Sprint map for columns
    ...
    for(String sprintName : project.getSprintNames()){
      ...
      // get map from sprint
      HashMap<String, String> map = sprint.toSimpleMap(); 
      Object[] values = new Object[map.size()]; //create an Object[] capable of holding all values associated with the sprint
